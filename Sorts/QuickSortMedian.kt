...
import DataStructures_and_Algorithms.Sorts.partitionLomuto
import DataStructures_and_Algorithms.Sorts.quicksortLomuto

fun<T: Comparable<T>> MutableList<T>.medianOfThree(
    low: Int,
    high: Int): Int {
...
fun<T: Comparable<T>> MutableList<T>.quicksortMedian(
    low: Int,
    high: Int) {
